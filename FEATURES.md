...
- Cartographer overlay fills ~80% of the viewport. Click a room to inspect (intel panel: name, area, Z/layer, biome, tags, exits, danger, residents). Travel is an explicit button or double-click. Paths are dashed vectors; nodes use corner brackets. Compact map tap selects and offers Inspect. Click-to-travel no longer auto-walks.
